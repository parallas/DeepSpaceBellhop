...
public class BackgroundStars
{
    ...
    public BackgroundStars(GraphicsDevice graphicsDevice)
    {
    ...
    public void Update()
    {
        for (var i = 0; i < _stars.Count; i++)
        {
            ...
            star.Position.Y -= MathHelper.Max(star.Size, star.ColorIndex * 0.05f) * _speed;
        ...
        _speed = MathUtil.ExpDecay(_speed, (dir * 6f) + 1f, 0.3f, 1f / 60f);
    }
    ...
    public void PreDraw(SpriteBatch spriteBatch)
    {
        ...
        spriteBatch.Begin(samplerState: SamplerState.LinearClamp);
        {
            ...
            {
                Vector2 speed = star.Position - star.LastPosition;
                float xScale = MathHelper.Clamp(0.75f / Math.Abs(speed.Y), 0f, 1f);
