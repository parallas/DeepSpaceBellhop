...
public static class SpriteBatchExtensions
{
    ...
    // {
    // 	spriteBatch.Draw(BaseRenderer.PixelTexture, start, null, color, (end - start).ToRotation(), new Vector2(0, 0.5f), new Vector2(Vector2.Distance(start, end), width), SpriteEffects.None, layerDepth);
    // }
    ...
    // {
    // 	spriteBatch.Draw(BaseRenderer.PixelTexture, start, null, color, direction, new Vector2(0, 0.5f), new Vector2(length, width), SpriteEffects.None, layerDepth);
    // }
}
